...
export interface StorageType {
  ...
  baseLiquidityPoolsForMargin: {
     ...
     **/
    identityInfos: StorageMap<string, Option<ITuple<[IdentityInfo, IdentityDepositBalanceOf, bool]>>>;
    /**
  ...
  marginLiquidityPools: {
     ...
     * @key2 TradingPair
     **/
    accumulatedSwapRates: StorageDoubleMap<string, string, SwapRate>;
    /**
     ...
     * @key2 TradingPair
     **/
    poolTradingPairOptions: StorageDoubleMap<string, string, MarginPoolTradingPairOption>;
    /**
  ...
  marginProtocol: {
     ...
     * @key1 PositionId
     **/
    positions: StorageMap<string, Option<MarginPosition>>;
    /**
  ...
  offences: {
     ...
     * @key2 OpaqueTimeSlot
     **/
    concurrentReportsIndex: StorageDoubleMap<string, string, Vec<ReportIdOf>>;
    /**
  ...
  syntheticLiquidityPools: {
     ...
     * @key1 CurrencyId
     **/
    maxSpread: StorageMap<string, Option<Balance>>;
    /**
  ...
  syntheticTokens: {
     ...
     * @key2 CurrencyId
     **/
    positions: StorageDoubleMap<string, string, SyntheticPosition>;
    /**
