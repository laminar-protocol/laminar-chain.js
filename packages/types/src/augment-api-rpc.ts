  ...
  export interface RpcInterface {
    margin: {
      ...
      poolState: AugmentedRpc<
        (pool_id: LiquidityPoolId | null, at?: BlockHash | string | Uint8Array) => Observable<MarginPoolState>
      >;
      /**
       *
       **/
    ...
    synthetic: {
       ...
       **/
      poolState: AugmentedRpc<
        (pool_id: LiquidityPoolId | null, currency_id: CurrencyId | null) => Observable<SyntheticPoolState>
      >;
    };
    oracle: {
      /**
