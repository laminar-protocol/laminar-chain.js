...
import type { MarginPoolState, MarginTraderState } from '@laminar/types/interfaces/margin';
import type { AccountId, BlockNumber, CurrencyId, H160, H256, H64, Hash, Header, Index, Justification, KeyValue, LiquidityPoolId, OracleKey, SignedBlock, StorageData } from '@laminar/types/interfaces/runtime';
import type { SyntheticPoolState } from '@laminar/types/interfaces/synthetic';
