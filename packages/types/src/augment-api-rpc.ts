...
declare module '@polkadot/rpc-core/types.jsonrpc' {
  export interface RpcInterface {
    margin: {
       ...
       * 
       **/
      traderState: AugmentedRpc<(who: AccountId | string | Uint8Array, pool_id: LiquidityPoolId | null, at?: BlockHash | string | Uint8Array) => Observable<MarginTraderState>>;
    };
    synthetic: {
      /**
       * 
    ...
    oracle: {
       ...
       **/
      getAllValues: AugmentedRpc<(providerId: RpcDataProviderId | null) => Observable<Vec<ITuple<[OracleKey, Option<TimestampedValue>]>>>>;
      /**
       * Retrieves the oracle value for a given key.
       **/
      getValue: AugmentedRpc<(providerId: RpcDataProviderId | null, key: OracleKey | null) => Observable<Option<TimestampedValue>>>;
    };
    author: {
      /**
