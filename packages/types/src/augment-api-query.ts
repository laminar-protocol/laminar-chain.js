...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    oracle: {
      ...
      hasUpdate: AugmentedQuery<ApiType, (arg: OracleKey | 'LAMI'|'AUSD'|'FEUR'|'FJPY'|'FBTC'|'FETH'|'FAUD'|'FCAD'|'FCHF'|'FXAU'|'FOIL' | number | Uint8Array) => Observable<bool>> & QueryableStorageEntry<ApiType>;
      rawValues: AugmentedQueryDoubleMap<ApiType, (key1: OracleKey | 'LAMI'|'AUSD'|'FEUR'|'FJPY'|'FBTC'|'FETH'|'FAUD'|'FCAD'|'FCHF'|'FXAU'|'FOIL' | number | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Option<TimestampedValueOf>>> & QueryableStorageEntry<ApiType>;
