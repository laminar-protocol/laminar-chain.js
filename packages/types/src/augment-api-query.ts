...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    syntheticLiquidityPools: {
      [index: string]: QueryableStorageEntry<ApiType>;
      liquidityPoolOptions: AugmentedQueryDoubleMap<ApiType, (key1: LiquidityPoolId | AnyNumber | Uint8Array, key2: CurrencyId | 'LAMI'|'AUSD'|'FEUR'|'FJPY'|'FBTC'|'FETH'|'FAUD'|'FCAD'|'FCHF'|'FXAU'|'FOIL'|'FGBP' | number | Uint8Array) => Observable<Option<SyntheticLiquidityPoolOption>>> & QueryableStorageEntry<ApiType>;
    ...
    syntheticTokens: {
      [index: string]: QueryableStorageEntry<ApiType>;
      collateralRatio: AugmentedQuery<ApiType, (arg: CurrencyId | 'LAMI'|'AUSD'|'FEUR'|'FJPY'|'FBTC'|'FETH'|'FAUD'|'FCAD'|'FCHF'|'FXAU'|'FOIL'|'FGBP' | number | Uint8Array) => Observable<Option<Permill>>> & QueryableStorageEntry<ApiType>;
      extremeRatio: AugmentedQuery<ApiType, (arg: CurrencyId | 'LAMI'|'AUSD'|'FEUR'|'FJPY'|'FBTC'|'FETH'|'FAUD'|'FCAD'|'FCHF'|'FXAU'|'FOIL'|'FGBP' | number | Uint8Array) => Observable<Option<Permill>>> & QueryableStorageEntry<ApiType>;
      liquidationRatio: AugmentedQuery<ApiType, (arg: CurrencyId | 'LAMI'|'AUSD'|'FEUR'|'FJPY'|'FBTC'|'FETH'|'FAUD'|'FCAD'|'FCHF'|'FXAU'|'FOIL'|'FGBP' | number | Uint8Array) => Observable<Option<Permill>>> & QueryableStorageEntry<ApiType>;
    ...
    tokens: {
       ...
       **/
      accounts: AugmentedQueryDoubleMap<ApiType, (key1: CurrencyId | 'LAMI'|'AUSD'|'FEUR'|'FJPY'|'FBTC'|'FETH'|'FAUD'|'FCAD'|'FCHF'|'FXAU'|'FOIL'|'FGBP' | number | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<AccountData>> & QueryableStorageEntry<ApiType>;
      /**
       * Any liquidity locks of a token type under an account.
       * NOTE: Should only be accessed when setting, changing and freeing a lock.
       **/
      locks: AugmentedQueryDoubleMap<ApiType, (key1: CurrencyId | 'LAMI'|'AUSD'|'FEUR'|'FJPY'|'FBTC'|'FETH'|'FAUD'|'FCAD'|'FCHF'|'FXAU'|'FOIL'|'FGBP' | number | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<Vec<BalanceLock>>> & QueryableStorageEntry<ApiType>;
      /**
