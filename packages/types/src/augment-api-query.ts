...
import { AccountId, Balance, CurrencyId, FixedI128, IdentityDepositBalanceOf, LiquidityPoolId, MarginPoolOption, MarginPoolTradingPairOption, MarginPosition, MarginTradingPairOption, Moment, OracleKey, Permill, Pool, PositionId, PositionsSnapshot, SwapRate, SyntheticPoolCurrencyOption, SyntheticPosition, SyntheticTokensRatio, TradingPair, TradingPairRiskThreshold } from '@laminar/types/interfaces/runtime';
...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    baseLiquidityPoolsForMargin: {
       ...
       **/
      identityInfos: AugmentedQuery<ApiType, (arg: LiquidityPoolId | AnyNumber | Uint8Array) => Observable<Option<ITuple<[IdentityInfo, IdentityDepositBalanceOf, bool]>>>> & QueryableStorageEntry<ApiType>;
      /**
