  ...
  export interface AugmentedQueries<ApiType> {
    ...
    marginLiquidityPools: {
      ...
      enabledTradingPairs: AugmentedQuery<
        ApiType,
        (arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<bool>>
      > &
        QueryableStorageEntry<ApiType>;
      ...
      maxSpread: AugmentedQuery<
        ApiType,
        (arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<Balance>>
      > &
        QueryableStorageEntry<ApiType>;
    ...
    marginProtocol: {
      ...
      balances: AugmentedQueryDoubleMap<
        ApiType,
        (key1: AccountId | string | Uint8Array, key2: LiquidityPoolId | AnyNumber | Uint8Array) => Observable<Fixed128>
      > &
        QueryableStorageEntry<ApiType>;
      liquidityPoolEllThreshold: AugmentedQuery<
        ApiType,
        (arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<RiskThreshold>>
      > &
        QueryableStorageEntry<ApiType>;
      liquidityPoolEnpThreshold: AugmentedQuery<
        ApiType,
        (arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<RiskThreshold>>
      > &
        QueryableStorageEntry<ApiType>;
      marginCalledPools: AugmentedQuery<
        ApiType,
        (arg: LiquidityPoolId | AnyNumber | Uint8Array) => Observable<Option<bool>>
      > &
        QueryableStorageEntry<ApiType>;
      ...
      > &
        QueryableStorageEntry<ApiType>;
      traderRiskThreshold: AugmentedQuery<
        ApiType,
        (arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<RiskThreshold>>
      > &
        QueryableStorageEntry<ApiType>;
    ...
    oracle: {
      ...
      hasUpdate: AugmentedQuery<
        ApiType,
        (arg: OracleKey | 'LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH' | number | Uint8Array) => Observable<bool>
      > &
        QueryableStorageEntry<ApiType>;
