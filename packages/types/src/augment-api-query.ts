  ...
  export interface AugmentedQueries<ApiType> {
    baseLiquidityPoolsForMargin: {
      ...
      owners: AugmentedQuery<
        ApiType,
        (arg: LiquidityPoolId | AnyNumber | Uint8Array) => Observable<Option<ITuple<[AccountId, LiquidityPoolId]>>>
      > &
        QueryableStorageEntry<ApiType>;
    };
    ...
    marginLiquidityPools: {
      ...
      > &
        QueryableStorageEntry<ApiType>;
      accumulates: AugmentedQuery<
        ApiType,
        (
          arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array
        ) => Observable<Option<ITuple<[AccumulateConfig, TradingPair]>>>
      > &
        QueryableStorageEntry<ApiType>;
      additionalSwapRate: AugmentedQuery<
        ApiType,
        (arg: LiquidityPoolId | AnyNumber | Uint8Array) => Observable<Option<Fixed128>>
      > &
        QueryableStorageEntry<ApiType>;
      defaultMinLeveragedAmount: AugmentedQuery<ApiType, () => Observable<Balance>> & QueryableStorageEntry<ApiType>;
      enabledTradingPairs: AugmentedQuery<
        ApiType,
        (arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<TradingPair>>
      > &
        QueryableStorageEntry<ApiType>;
      liquidityPoolEnabledTradingPairs: AugmentedQueryDoubleMap<
        ApiType,
        (
          key1: LiquidityPoolId | AnyNumber | Uint8Array,
          key2: TradingPair | { base?: any; quote?: any } | string | Uint8Array
        ) => Observable<Option<TradingPair>>
      > &
        QueryableStorageEntry<ApiType>;
      liquidityPoolOptions: AugmentedQueryDoubleMap<
        ApiType,
        (
          key1: LiquidityPoolId | AnyNumber | Uint8Array,
          key2: TradingPair | { base?: any; quote?: any } | string | Uint8Array
        ) => Observable<Option<MarginLiquidityPoolOption>>
      > &
        QueryableStorageEntry<ApiType>;
      maxSpread: AugmentedQuery<
        ApiType,
        (arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<Permill>>
      > &
        QueryableStorageEntry<ApiType>;
      minLeveragedAmount: AugmentedQuery<
        ApiType,
        (arg: LiquidityPoolId | AnyNumber | Uint8Array) => Observable<Option<Balance>>
      > &
        QueryableStorageEntry<ApiType>;
      swapRates: AugmentedQuery<
        ApiType,
        (arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<SwapRate>>
      > &
        QueryableStorageEntry<ApiType>;
    };
    marginProtocol: {
      [index: string]: QueryableStorageEntry<ApiType>;
      balances: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<Fixed128>> &
        QueryableStorageEntry<ApiType>;
      liquidityPoolELLThreshold: AugmentedQuery<ApiType, () => Observable<RiskThreshold>> &
        QueryableStorageEntry<ApiType>;
      liquidityPoolENPThreshold: AugmentedQuery<ApiType, () => Observable<RiskThreshold>> &
        QueryableStorageEntry<ApiType>;
      ...
      > &
        QueryableStorageEntry<ApiType>;
      marginCalledTraders: AugmentedQuery<
        ApiType,
        (arg: AccountId | string | Uint8Array) => Observable<Option<ITuple<[]>>>
      > &
        QueryableStorageEntry<ApiType>;
    ...
    oracle: {
      ...
      hasUpdate: AugmentedQuery<
        ApiType,
        (
          arg: OracleKey | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array
        ) => Observable<bool>
      > &
        QueryableStorageEntry<ApiType>;
      rawValues: AugmentedQueryDoubleMap<
        ApiType,
        (
          key1: OracleKey | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array,
    ...
    syntheticLiquidityPools: {
      ...
      liquidityPoolOptions: AugmentedQueryDoubleMap<
        ...
        (
          key1: LiquidityPoolId | AnyNumber | Uint8Array,
          key2: CurrencyId | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array
        ) => Observable<Option<SyntheticLiquidityPoolOption>>
      > &
        QueryableStorageEntry<ApiType>;
      maxSpread: AugmentedQuery<
        ApiType,
        (
          arg: CurrencyId | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array
        ) => Observable<Permill>
      > &
        QueryableStorageEntry<ApiType>;
    ...
    tokens: {
      ...
      accounts: AugmentedQueryDoubleMap<
        ApiType,
        (
          key1: CurrencyId | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array,
          key2: AccountId | string | Uint8Array
