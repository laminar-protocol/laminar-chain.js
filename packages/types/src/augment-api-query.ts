...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    marginLiquidityPools: {
      ...
      enabledTradingPairs: AugmentedQuery<ApiType, (arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<TradingPair>>> & QueryableStorageEntry<ApiType>;
      liquidityPoolEnabledTradingPairs: AugmentedQueryDoubleMap<ApiType, (key1: LiquidityPoolId | AnyNumber | Uint8Array, key2: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<TradingPair>>> & QueryableStorageEntry<ApiType>;
      ...
      maxSpread: AugmentedQuery<ApiType, (arg: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => Observable<Option<Permill>>> & QueryableStorageEntry<ApiType>;
    ...
    marginProtocol: {
      [index: string]: QueryableStorageEntry<ApiType>;
      balances: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<Fixed128>> & QueryableStorageEntry<ApiType>;
      liquidityPoolELLThreshold: AugmentedQuery<ApiType, () => Observable<RiskThreshold>> & QueryableStorageEntry<ApiType>;
      liquidityPoolENPThreshold: AugmentedQuery<ApiType, () => Observable<RiskThreshold>> & QueryableStorageEntry<ApiType>;
      ...
      marginCalledTraders: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<Option<ITuple<[]>>>> & QueryableStorageEntry<ApiType>;
      ...
      traderRiskThreshold: AugmentedQuery<ApiType, () => Observable<RiskThreshold>> & QueryableStorageEntry<ApiType>;
    };
    oracle: {
      [index: string]: QueryableStorageEntry<ApiType>;
    ...
    syntheticLiquidityPools: {
      ...
      maxSpread: AugmentedQuery<ApiType, (arg: CurrencyId | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array) => Observable<Permill>> & QueryableStorageEntry<ApiType>;
