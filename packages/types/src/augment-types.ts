...
import { AuctionInfo, DelayedDispatchTime, DispatchId } from '@open-web3/orml-types/interfaces/traits';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    SwapRate: SwapRate;
    'Option<SwapRate>': Option<SwapRate>;
    'Vec<SwapRate>': Vec<SwapRate>;
    ...
    AccumulateConfig: AccumulateConfig;
    'Option<AccumulateConfig>': Option<AccumulateConfig>;
    'Vec<AccumulateConfig>': Vec<AccumulateConfig>;
    IdentityDepositBalanceOf: IdentityDepositBalanceOf;
    'Option<IdentityDepositBalanceOf>': Option<IdentityDepositBalanceOf>;
    'Vec<IdentityDepositBalanceOf>': Vec<IdentityDepositBalanceOf>;
    Pool: Pool;
    'Option<Pool>': Option<Pool>;
    'Vec<Pool>': Vec<Pool>;
    MarginTradingPairOption: MarginTradingPairOption;
    'Option<MarginTradingPairOption>': Option<MarginTradingPairOption>;
    'Vec<MarginTradingPairOption>': Vec<MarginTradingPairOption>;
    MarginPoolOption: MarginPoolOption;
    'Option<MarginPoolOption>': Option<MarginPoolOption>;
    'Vec<MarginPoolOption>': Vec<MarginPoolOption>;
    MarginPoolTradingPairOption: MarginPoolTradingPairOption;
    'Option<MarginPoolTradingPairOption>': Option<MarginPoolTradingPairOption>;
    'Vec<MarginPoolTradingPairOption>': Vec<MarginPoolTradingPairOption>;
    SyntheticPoolCurrencyOption: SyntheticPoolCurrencyOption;
    'Option<SyntheticPoolCurrencyOption>': Option<SyntheticPoolCurrencyOption>;
    'Vec<SyntheticPoolCurrencyOption>': Vec<SyntheticPoolCurrencyOption>;
    ...
    'Vec<Rate>': Vec<Rate>;
    PoolTraderInfo: PoolTraderInfo;
    'Option<PoolTraderInfo>': Option<PoolTraderInfo>;
    'Vec<PoolTraderInfo>': Vec<PoolTraderInfo>;
    PairInfo: PairInfo;
    'Option<PairInfo>': Option<PairInfo>;
    'Vec<PairInfo>': Vec<PairInfo>;
    TradingPairRiskThreshold: TradingPairRiskThreshold;
    'Option<TradingPairRiskThreshold>': Option<TradingPairRiskThreshold>;
    'Vec<TradingPairRiskThreshold>': Vec<TradingPairRiskThreshold>;
    SyntheticTokensRatio: SyntheticTokensRatio;
    'Option<SyntheticTokensRatio>': Option<SyntheticTokensRatio>;
    'Vec<SyntheticTokensRatio>': Vec<SyntheticTokensRatio>;
    PositionsSnapshot: PositionsSnapshot;
    'Option<PositionsSnapshot>': Option<PositionsSnapshot>;
    'Vec<PositionsSnapshot>': Vec<PositionsSnapshot>;
    LeveragedAmounts: LeveragedAmounts;
    'Option<LeveragedAmounts>': Option<LeveragedAmounts>;
    'Vec<LeveragedAmounts>': Vec<LeveragedAmounts>;
    LiquidityPoolIdentityInfo: LiquidityPoolIdentityInfo;
    'Option<LiquidityPoolIdentityInfo>': Option<LiquidityPoolIdentityInfo>;
    'Vec<LiquidityPoolIdentityInfo>': Vec<LiquidityPoolIdentityInfo>;
    MarginPoolState: MarginPoolState;
    'Option<MarginPoolState>': Option<MarginPoolState>;
    'Vec<MarginPoolState>': Vec<MarginPoolState>;
    MarginTraderState: MarginTraderState;
    'Option<MarginTraderState>': Option<MarginTraderState>;
    'Vec<MarginTraderState>': Vec<MarginTraderState>;
    SyntheticPoolState: SyntheticPoolState;
    'Option<SyntheticPoolState>': Option<SyntheticPoolState>;
    'Vec<SyntheticPoolState>': Vec<SyntheticPoolState>;
  }
}
