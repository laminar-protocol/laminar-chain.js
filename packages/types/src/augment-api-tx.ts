...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    syntheticLiquidityPools: {
       ...
       * May only be called from `UpdateOrigin`.
       **/
      setMaxSpread: AugmentedSubmittable<(currencyId: CurrencyId | 'LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH' | 'FAUD' | 'FCAD' | 'FCHF' | 'FXAU' | 'FOIL' | 'FGBP' | number | Uint8Array, maxSpread: Compact<Price> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CurrencyId, Compact<Price>]>;
      /**
       ...
       * May only be called from the pool owner.
       **/
      setSpread: AugmentedSubmittable<(poolId: Compact<LiquidityPoolId> | AnyNumber | Uint8Array, currencyId: CurrencyId | 'LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH' | 'FAUD' | 'FCAD' | 'FCHF' | 'FXAU' | 'FOIL' | 'FGBP' | number | Uint8Array, bid: Compact<Price> | AnyNumber | Uint8Array, ask: Compact<Price> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<LiquidityPoolId>, CurrencyId, Compact<Price>, Compact<Price>]>;
      /**
    ...
    tokens: {
       ...
       * # </weight>
       **/
      transferAll: AugmentedSubmittable<(dest: LookupSource | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, currencyId: CurrencyId | 'LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH' | 'FAUD' | 'FCAD' | 'FCHF' | 'FXAU' | 'FOIL' | 'FGBP' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [LookupSource, CurrencyId]>;
    };
  }
