  ...
  export interface AugmentedSubmittables<ApiType> {
    baseLiquidityPoolsForMargin: {
      ...
      clearIdentity: AugmentedSubmittable<
        (poolId: Compact<LiquidityPoolId> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       * May only be called from the pool owner.
       **/
      transferLiquidityPool: AugmentedSubmittable<
        (
          poolId: Compact<LiquidityPoolId> | AnyNumber | Uint8Array,
    ...
    currencies: {
      ...
      transfer: AugmentedSubmittable<
        (
          dest: LookupSource | Address | AccountId | AccountIndex | LookupSource | string | Uint8Array,
          currencyId:
            | CurrencyIdOf
            | 'LAMI'
            | 'AUSD'
      ...
      updateBalance: AugmentedSubmittable<
        (
          who: LookupSource | Address | AccountId | AccountIndex | LookupSource | string | Uint8Array,
          currencyId:
            | CurrencyIdOf
            | 'LAMI'
            | 'AUSD'
    ...
    marginLiquidityPools: {
       ...
       * May only be called from `UpdateOrigin`.
       **/
      setAccumulateConfig: AugmentedSubmittable<
        (
          pair: TradingPair | { base?: any; quote?: any } | string | Uint8Array,
          frequency: Moment | AnyNumber | Uint8Array,
          offset: Moment | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       * May only be called from the pool owner.
       **/
      setAdditionalSwapRate: AugmentedSubmittable<
        (
          poolId: Compact<LiquidityPoolId> | AnyNumber | Uint8Array,
          rate: FixedI128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
       ...
       * May only be called from the pool owner.
       **/
      setEnabledLeverages: AugmentedSubmittable<
        (
          poolId: Compact<LiquidityPoolId> | AnyNumber | Uint8Array,
          pair: TradingPair | { base?: any; quote?: any } | string | Uint8Array,
          enabled: Leverages
      ...
      setMaxSpread: AugmentedSubmittable<
        (
          pair: TradingPair | { base?: any; quote?: any } | string | Uint8Array,
          maxSpread: Compact<Balance> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      setSpread: AugmentedSubmittable<
        (
          poolId: Compact<LiquidityPoolId> | AnyNumber | Uint8Array,
          pair: TradingPair | { base?: any; quote?: any } | string | Uint8Array,
          bid: Compact<Balance> | AnyNumber | Uint8Array,
          ask: Compact<Balance> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
    ...
    marginProtocol: {
      ...
      closePosition: AugmentedSubmittable<
        (
          positionId: Compact<PositionId> | AnyNumber | Uint8Array,
      ...
      setTradingPairRiskThreshold: AugmentedSubmittable<
        (
          pair: TradingPair | { base?: any; quote?: any } | string | Uint8Array,
          trader: Option<RiskThreshold> | null | object | string | Uint8Array,
          enp: Option<RiskThreshold> | null | object | string | Uint8Array,
          ell: Option<RiskThreshold> | null | object | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
    ...
    syntheticLiquidityPools: {
      ...
      setMinAdditionalCollateralRatio: AugmentedSubmittable<
        (ratio: Compact<Permill> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>
      >;
      /**
      ...
      setCollateralRatio: AugmentedSubmittable<
        (
          currencyId:
            ...
            | number
            | Uint8Array,
          ratio: Compact<Permill> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>
      >;
      /**
