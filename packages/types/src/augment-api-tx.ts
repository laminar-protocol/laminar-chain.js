...
import { AccountId, AccountIndex, Address, AmountOf, Balance, BalanceOf, BlockNumber, Call, CurrencyId, CurrencyIdOf, Fixed128, Leverage, Leverages, LiquidityPoolId, LookupSource, OracleKey, OracleValue, Permill, PositionId, SwapRate, TradingPair } from '@laminar/types/interfaces/runtime';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    baseLiquidityPoolsForMargin: {
      ...
      depositLiquidity: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      withdrawLiquidity: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    ...
    marginLiquidityPools: {
      ...
      liquidityPoolDisableTradingPair: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, pair: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      liquidityPoolEnableTradingPair: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, pair: TradingPair | { base?: any; quote?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      setAdditionalSwap: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, rate: Fixed128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      setEnabledTrades: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, pair: TradingPair | { base?: any; quote?: any } | string | Uint8Array, enabled: Leverages) => SubmittableExtrinsic<ApiType>>;
      setMaxSpread: AugmentedSubmittable<(pair: TradingPair | { base?: any; quote?: any } | string | Uint8Array, maxSpread: Permill | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      setMinLeveragedAmount: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      setSpread: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, pair: TradingPair | { base?: any; quote?: any } | string | Uint8Array, bid: Permill | AnyNumber | Uint8Array, ask: Permill | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    ...
    marginProtocol: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      closePosition: AugmentedSubmittable<(positionId: PositionId | AnyNumber | Uint8Array, price: Price | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      deposit: AugmentedSubmittable<(amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      liquidityPoolBecomeSafe: AugmentedSubmittable<(pool: LiquidityPoolId | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      liquidityPoolForceClose: AugmentedSubmittable<(pool: LiquidityPoolId | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      liquidityPoolMarginCall: AugmentedSubmittable<(pool: LiquidityPoolId | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      traderBecomeSafe: AugmentedSubmittable<(who: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      traderMarginCall: AugmentedSubmittable<(who: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      traderStopOut: AugmentedSubmittable<(who: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      withdraw: AugmentedSubmittable<(amount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    oracle: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    syntheticLiquidityPools: {
      ...
      setMaxSpread: AugmentedSubmittable<(currencyId: CurrencyId | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array, maxSpread: Permill | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      setMinAdditionalCollateralRatio: AugmentedSubmittable<(ratio: Permill | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      setSpread: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, currencyId: CurrencyId | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array, bid: Permill | AnyNumber | Uint8Array, ask: Permill | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    ...
    syntheticProtocol: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      addCollateral: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, currencyId: CurrencyId | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array, collateralAmount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      liquidate: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, currencyId: CurrencyId | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array, syntheticAmount: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      mint: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, currencyId: CurrencyId | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array, collateralAmount: Compact<Balance> | AnyNumber | Uint8Array, maxPrice: Price | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      redeem: AugmentedSubmittable<(poolId: LiquidityPoolId | AnyNumber | Uint8Array, currencyId: CurrencyId | ('LAMI' | 'AUSD' | 'FEUR' | 'FJPY' | 'FBTC' | 'FETH') | number | Uint8Array, syntheticAmount: Compact<Balance> | AnyNumber | Uint8Array, minPrice: Price | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
